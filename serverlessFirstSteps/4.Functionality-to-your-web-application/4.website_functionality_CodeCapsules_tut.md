...
In the [previous section](#implementingthesubscribebutton), we added the `POST` method to the subscribe button. We will therefor know when someone has clicked the subscribe button with the line:
